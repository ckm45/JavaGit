...
public class MakeList {
    ...
    public List<Member> memberlist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            Member mem = new Member(Integer.parseInt(l.get(0)), l.get(1), l.get(2), l.get(3),
                    l.get(4),l.get(5));
            memberlist.add(mem);
    ...
    public List<BookInfo> booklist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            List<String> l = list.get(i);
            BookInfo book = new BookInfo(Integer.parseInt(l.get(0)), l.get(1), l.get(2),
    ...
    public List<Loan> loanlist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            List<String> l = list.get(i);
            Loan loan = new Loan(Integer.parseInt(l.get(0)), l.get(1), l.get(2), l.get(3), l.get(4),
                    Boolean.valueOf(l.get(5)));
            loanlist.add(loan);
        }
        return loanlist;
    }
