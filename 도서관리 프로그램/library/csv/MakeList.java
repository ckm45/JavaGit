...
public class MakeList {
    ...
    public List<Map<Integer, Member>> memberlist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            mem.put(Integer.parseInt(l.get(0)),new Member(l.get(1), l.get(2), l.get(3), l.get(4)))e;
            memberlist.add(mem);
        }
        return memberlist;
    }
    ...
    public List<Book> booklist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            List<String> l = list.get(i);
            Book b = new Book(Integer.parseInt(l.get(0)), l.get(1), l.get(2),
    ...
    public List<Loan> loanlist() {
        ...
        for (int i = 1; i < list.size(); i++) {
            List<String> l = list.get(i);
            Loan loan = new Loan(Integer.parseInt(l.get(0)), l.get(1), l.get(2),
                    Boolean.valueOf(l.get(3)), l.get(4), Integer.parseInt(l.get(5)),
                    Boolean.valueOf(l.get(6)));
            loanlist.add(loan);
        }
        return loanlist;
    }
