...
REM ********************************************************************
CREATE TABLE MEMBER(
    ID          VARCHAR2(8)     CONSTRAINT MEMBER_ID_PK PRIMARY KEY,
...
CREATE TABLE BOOK(
    BOOKID       VARCHAR2(8)      CONSTRAINT BOOK_ID_PK PRIMARY KEY,
...
CREATE TABLE LOAN(
    LOANID                    VARCHAR2(8)     CONSTRAINT LOAN_ID_PK PRIMARY KEY,
    MEMBERID                  VARCHAR2(8)     NOT NULL, CONSTRAINT LOAN_MEMBER_FK FOREIGN KEY(MEMBERID) 
                                                REFERENCES MEMBER(ID),
    BOOKID                    VARCHAR2(8)     NOT NULL, CONSTRAINT LOAN_BOOK_FK FOREIGN KEY(BOOKID)
